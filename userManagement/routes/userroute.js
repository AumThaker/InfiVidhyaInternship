...
import { activateUser, changeDetails, changePasswordSendOtp, createUser, deactivateUser, loginUser, logoutUser, registerUser, updatePass } from "../controllers/usercontrol.js";
const router = Router()
